 ...
 */
@Entity
@Table(name = "tr_maritimo")
@Data
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(onlyExplicitlyIncluded = true)
public class TrMaritimo implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "numero_flota", nullable = false, length = 8)
    ...
    @JoinColumn(name = "id_puerto", referencedColumnName = "id", nullable = false)
    @ManyToOne(optional = false)
    private CcPuerto puerto;
